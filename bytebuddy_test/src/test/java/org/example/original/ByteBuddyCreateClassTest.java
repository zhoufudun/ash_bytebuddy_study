...
public class ByteBuddyCreateClassTest {
    ...
    public void test02() throws IOException {
        ...
        DynamicType.Unloaded<NothingClass> noJdkSubClass = new ByteBuddy()
                ...
                .make();
        // 2. 将生成的字节码保存到 本地 (由于没有直接指定类名, 每次运行时生成不同的类, 类名不同)
        // 我本地第一次运行: org.example.original.NothingClass$ByteBuddy$f7zBKYwS
        // 我本地第二次运行: org.example.original.NothingClass$ByteBuddy$FHZdoEVm
    ...
    public void test24() throws IOException {
        ...
        TypeDescription classPathTypeDescription = typePool.describe("org.example.original.NothingClass").resolve();
